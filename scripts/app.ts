...
(function (){
    ...
    /**
     * Binds click, mouseover, mouseout events to anchor tags with the class 'link' and a matching data attribute
     ...
     * removes any existing click and mouseover events before adding new ones to control navigation behaviour
     */
    ...
    /**
     * Updates the applications current active link, manages authentication and updates browser history
